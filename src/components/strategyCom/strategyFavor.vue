<template lang="html">
<div class="favor">
      <FavorHeaderCom :hotStrategyText="hotStrategyText"/>
      <div class="favorView">
        <swiper :options="swiperOption" ref="mySwiper">
          <swiper-slide v-for="(item,index) in imgArr" :key="index">
              <router-link tag="div" :to="{name:'favorSide',params:{ type:types,id:index}}">
...
import FavorHeaderCom from "./favorHeaderCom"
export default {
  name:"strategyFavor",
  data(){
    return{
